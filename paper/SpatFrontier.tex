...
\subfigure[Agriculture]{\includegraphics[width = 0.48\textwidth]{fig/TEfrontierAgr}}
\subfigure{\includegraphics[width = 0.48\textwidth]{fig/TEfrontierEM}}\\[-2ex]
\subfigure{\includegraphics[width = 0.48\textwidth]{fig/TEfrontierCon}}
\subfigure{\includegraphics[width = 0.48\textwidth]{fig/TEfrontierDist}}\\
\subfigure{\includegraphics[width = 0.48\textwidth]{fig/TEfrontierServ}}
\subfigure{\includegraphics[width = 0.48\textwidth]{fig/TEfrontierNMServ}}
\end{figure}
%
